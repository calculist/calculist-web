...
import $ from 'jquery';
import lmSessionStorage from '../services/lmSessionStorage';
import getItemByGuid from '../../shared/Item/getItemByGuid';
import undoManager from '../services/undoManager';
import eventHub from '../services/eventHub';

const zoomPage = (function (_, $, Promise, lmSessionStorage, getItemByGuid, undoManager, eventHub) {
  ...
  return zoomPage;
})(_, $, Promise, lmSessionStorage, getItemByGuid, undoManager, eventHub);
