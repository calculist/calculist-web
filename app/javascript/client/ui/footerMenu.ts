...
import userAgentHelper from '../services/userAgentHelper';

const footerMenu = (function (_, eventHub, zoomPage, undoManager, userAgentHelper) {
  var commands = [
    'zoom in', 'zoom out',
    'expand', 'collapse',
    'indent', 'outdent',
...
})(_, eventHub, zoomPage, undoManager, userAgentHelper);
