...
import keydownToString from '../utility/keydownToString';
...
const customKeyboardShortcuts = (function (_, keydownToString, transaction, userPreferences, executeCommand) {
...
})(_, keydownToString, transaction, userPreferences, executeCommand);

export default customKeyboardShortcuts;
