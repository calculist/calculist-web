...
import replaceTeX from './replaceTeX';
import _ from 'lodash';
import userIsTyping from '../../client/services/userIsTyping';
import slashElementsHelper from '../../client/services/slashElementsHelper';

(function (Item, replaceTeX, _, userIsTyping, slashElementsHelper) {
...
})(Item, replaceTeX, _, userIsTyping, slashElementsHelper);
