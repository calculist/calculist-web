...
import editMode from '../../client/services/editMode';

(function (Item, cursorPosition, isReadOnly, itemOfFocus, itemOfDrag, editMode) {
  // TODO move this
...
})(Item, cursorPosition, isReadOnly, itemOfFocus, itemOfDrag, editMode);
