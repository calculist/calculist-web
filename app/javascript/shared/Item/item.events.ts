...
(function (Item, _, isReadOnly, itemTagsHelper, userAgentHelper) {
  ...
  Item.prototype.events = function() {
    ...
    if (userAgentHelper.isMobileDevice) events["click #input" + id] = 'handleNonEditFocus';
...
})(Item, _, isReadOnly, itemTagsHelper, userAgentHelper);
