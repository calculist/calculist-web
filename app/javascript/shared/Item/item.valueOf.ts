...
import somethingHasChanged from '../../client/services/somethingHasChanged';
import syncAnimationFrame from '../../client/services/syncAnimationFrame';
import eventHub from '../../client/services/eventHub';
import computationIsPaused from '../../client/services/computationIsPaused';

(function (Item, _, parseItemText, computeItemValue, somethingHasChanged, syncAnimationFrame, eventHub, computationIsPaused) {
...
})(Item, _, parseItemText, computeItemValue, somethingHasChanged, syncAnimationFrame, eventHub, computationIsPaused);
