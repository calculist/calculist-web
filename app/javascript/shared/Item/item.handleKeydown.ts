...
import $ from 'jquery';
import customKeyboardShortcuts from './item.customKeyboardShortcuts';
...
const item_handleKeydown = (function (_, $, customKeyboardShortcuts, cursorPosition, transaction, commandTypeahead, zoomPage, executeCommand, eventHub, itemOfFocus) {
...
})(_, $, customKeyboardShortcuts, cursorPosition, transaction, commandTypeahead, zoomPage, executeCommand, eventHub, itemOfFocus);

export default item_handleKeydown;
